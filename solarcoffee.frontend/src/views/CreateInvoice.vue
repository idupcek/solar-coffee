      ...
      <div class="invoice-step" v-if="invoiceStep === 3">
        ...
        <div class="invoice-step-detail" id="invoice" ref="invoice">
          <div class="invoice-logo">
            <img src="../assets/images/solar_coffee_logo.png" alt="Solar Coffee logo" id="imgLogo">
            <h3>1337 Solar Lane</h3>
            <h3>Somewhere, Auckland</h3>
            <h3>NZ</h3>
...
export default class CreateInvoice extends Vue {
  ...
  //computed properties (get syntax). will get recomputed if any of its dependencies change
  get canGoNext() {
  ...
  addLineItem() {
    ...
    //reset newItem for adding another lineItem after this one
  ...
  async initialize() {
    //alternative way below, using then syntax
